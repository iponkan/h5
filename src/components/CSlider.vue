<template>
    ...
    <div>
        ...
        <img
            ...
            :src="audio_img_url"
            style="width: 43.3929px; height: 43.3929px; right: 21.6964px; top: 21.6964px; opacity: 1; position: absolute; display: block; z-index: 1000000; touch-action: pan-y; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"
        />
...
export default {
    ...
    data() {
        return {
            ...
            curPage: 0,
            audio_img_url:"//res.maka.im/cdn/maka/release/musicon.png?6f72b5cfdeb5c543944d738bbd4d9a18",
            options: {
                currentPage: 0,
                direction: "vertical",
                freeze: false,
    ...
    methods: {
        ...
        play() {
            ...
            if (!this.isPlaying) {
                audio.play();
                this.isPlaying = true;
                this.audio_img_url = "//res.maka.im/cdn/maka/release/musicon.png?6f72b5cfdeb5c543944d738bbd4d9a18"
            }
        },
        stop() {
            var audio = document.querySelector("#audio");
            if (this.isPlaying) {
                audio.pause();
                this.audio_img_url = "//res.maka.im/cdn/maka/release/musicoff.png?0351a5ffcb05654c5e110b203375cefd"
                audio.currentTime = 0;
